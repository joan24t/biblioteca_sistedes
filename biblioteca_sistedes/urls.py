...
urlpatterns = [
    ...
    path('conference_update/<int:pk>/', views.ConferenceCreate.as_view(), name='Actualizar conferencia'),
    ...
    path('edition_update/<int:pk>/', views.EditionCreate.as_view(), name='Actualizar edición'),
    ...
    path('track_update/<int:pk>/', views.TrackCreate.as_view(), name='Actualizar track'),
    ...
    path('author_update/<int:pk>/', views.AuthorCreate.as_view(), name='Actualizar autor'),
    path('author_delete/<int:pk>/', views.AuthorDelete, name='Eliminar autor'),
    path('article_list/', views.ArticleList.as_view(), name='Lista de articulos'),
    path('article_create/', views.ArticleCreate.as_view(), name='Crear articulo'),
    path('article_update/<int:pk>/', views.ArticleCreate.as_view(), name='Actualizar articulo'),
    ...
    path('keyword_update/<int:pk>/', views.KeywordCreate.as_view(), name='Modificar palabra clave'),
    path('user_list/', views.UserList.as_view(), name='Lista de usuarios'),
    path('user_create/', views.UserCreate.as_view(), name='Crear Usuario'),
    path('user_update/<int:pk>/', views.UserCreate.as_view(), name='Actualizar usuario'),
