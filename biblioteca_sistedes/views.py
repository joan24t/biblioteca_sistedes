...
class ConferenceList(ListView):
	...
	def get(self, request, **kwargs):
		...
		if username and rol == 1:
			...
			context.update(global_context())
			return render(request, 'biblioteca_sistedes/conference_list.html' , context)
		else:
			return HttpResponseRedirect('/')
...
class AuthorList(ListView):
	...
	def get(self, request, **kwargs):
		...
		if username:
			...
			context.update(global_context())
			return render(request, 'biblioteca_sistedes/author_list.html' , context)
		else:
			return HttpResponseRedirect('/')
...
class KeywordList(ListView):
	...
	def get(self, request, **kwargs):
		...
		if username and rol == 1:
			...
			context.update(global_context())
			return render(request, 'biblioteca_sistedes/keyword_list.html' , context)
		else:
			return HttpResponseRedirect('/')
...
class UserList(ListView):
	...
	def get(self, request, **kwargs):
		...
		if username and rol == 1:
			...
			context.update(global_context())
			return render(request, 'biblioteca_sistedes/user_list.html' , context)
		else:
			return HttpResponseRedirect('/')
...
class ConferenceCreate(CreateView):
	...
	def get(self, request, **kwargs):
		...
		if username and rol == 1:
			...
			context.update(global_context())
			return render(request, 'biblioteca_sistedes/conference_create.html' , context)
		else:
			return HttpResponseRedirect('/')
...
class EditionCreate(CreateView):
	...
	def get(self, request, **kwargs):
		...
		if username and rol == 1:
			...
			context.update(global_context())
			return render(request, 'biblioteca_sistedes/edition_create.html' , context)
		else:
			return HttpResponseRedirect('/')
...
class AuthorCreate(CreateView):
	...
	def get(self, request, **kwargs):
		...
		if username:
			...
			context.update(global_context())
			return render(request, 'biblioteca_sistedes/author_create.html' , context)
		else:
			return HttpResponseRedirect('/')
...
class TrackCreate(CreateView):
	...
	def get(self, request, **kwargs):
		...
		if username and (rol == 1 or rol == 2):
			...
			context.update(global_context())
			return render(request, 'biblioteca_sistedes/track_create.html' , context)
		else:
			return HttpResponseRedirect('/')
...
class ArticleCreate(CreateView):
	...
	def get(self, request, **kwargs):
		...
		if username:
			...
			context.update(global_context())
			return render(request, 'biblioteca_sistedes/article_create.html' , context)
		else:
			return HttpResponseRedirect('/')
...
class KeywordCreate(CreateView):
	...
	def get(self, request, **kwargs):
		...
		if username:
			...
			context.update(global_context())
			return render(request, 'biblioteca_sistedes/keyword_create.html' , context)
		else:
			return HttpResponseRedirect('/')
...
class UserCreate(CreateView):
	...
	def get(self, request, **kwargs):
		...
		if username and rol == 1:
			...
			context.update(global_context())
			return render(request, 'biblioteca_sistedes/user_registration.html' , context)
		else:
			return HttpResponseRedirect('/')
